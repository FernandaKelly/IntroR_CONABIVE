...
if_any() e if_all() aplicam a mesma função de predicado a uma seleção de colunas e combinam os resultados em um único vetor lógico: if_any() é TRUE quando o predicado é TRUE para qualquer uma das colunas selecionadas, if_all() é TRUE quando o predicado é TRUE para todas as colunas selecionadas.
